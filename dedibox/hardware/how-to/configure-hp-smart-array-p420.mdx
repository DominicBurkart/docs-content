...
<Navigation title="See Also">
  <PreviousButton to="/dedibox/hardware/how-to/configure-hp-smart-array-p410/">How to configure the HP SMART ARRAY P410/P22 RAID controller</PreviousButton>
  <NextButton to="/dedibox/hardware/how-to/configure-raid-kvm-h200/">How to configure the DELL PERC H200 RAID controller from the KVM</NextButton>
</Navigation>
