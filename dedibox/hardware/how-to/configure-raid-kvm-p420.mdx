...
<Navigation title="See Also">
  <PreviousButton to="/dedibox/hardware/how-to/configure-raid-kvm-p410/">How to configure the HP Smart Array P410 RAID controller from the KVM</PreviousButton>
</Navigation>
