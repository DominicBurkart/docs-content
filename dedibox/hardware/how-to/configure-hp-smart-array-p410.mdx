...
<Navigation title="See Also">
  <PreviousButton to="/dedibox/hardware/how-to/configure-dell-perc-h800/">How to configure the DELL PERC H800 RAID controller</PreviousButton>
  <NextButton to="/dedibox/hardware/how-to/configure-hp-smart-array-p420/">How to configure the HP SMART ARRAY P420 RAID controller</NextButton>
</Navigation>
