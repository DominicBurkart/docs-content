...
<Navigation title="See Also">
  <PreviousButton to="/dedibox/kvm-over-ip/how-to/supermicro/">How to use the Supermicro KVM</PreviousButton>
  <NextButton to="/dedibox/kvm-over-ip/how-to/quantaplex/">How to use the QuantaPlex KVM</NextButton>
</Navigation>