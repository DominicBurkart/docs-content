...
<Navigation title="See Also">
  <PreviousButton to="/dedibox/kvm-over-ip/how-to/dell-idrac8/">How to use DELL iDRAC 8</PreviousButton>
  <NextButton to="/dedibox/kvm-over-ip/how-to/supermicro/">How to use the Supermicro KVM</NextButton>
</Navigation>