...
<Navigation title="See Also">
  <PreviousButton to="/dedibox/kvm-over-ip/how-to/hp-ilo/">How to use HP iLO</PreviousButton>
  <NextButton to="/dedibox/kvm-over-ip/how-to/dell-idrac7/">How to use DELL iDRAC 7</NextButton>
</Navigation>