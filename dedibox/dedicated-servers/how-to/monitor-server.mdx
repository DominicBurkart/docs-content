...
3. Click **Monitoring** in the left side menu. The monitoring page displays.
  ...
  <Lightbox src="scaleway-dedibox-monitoring.webp" alt="" />
...
4. Depending on the alert type you chose, enter your e-mail address or phone number in the final box.
...
1. From the console, click **Server** > **Server list**. A list of your servers displays.
2. Click **Manage** next to the server you want to monitor.
3. Click **Logs** in the left side menu. The logs page displays.
    <Lightbox src="scaleway-dedibox-logs.webp" alt="" />


<Navigation title="See Also">
  <PreviousButton to="/dedibox/dedicated-servers/how-to/change-win-server-language/">How to change the language of a Windows Server</PreviousButton>
  <NextButton to="/dedibox/dedicated-servers/how-to/use-dedibackup-ftp-backup/">How to use the Dedibackup FTP backup space</NextButton>
</Navigation>
