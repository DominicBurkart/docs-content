...
<Navigation title="See Also">
  <PreviousButton to="/webhosting/classic/how-to/change-password-postgresql-database/">How to change the password of a PostGreSQL database</PreviousButton>
  <NextButton to="/webhosting/classic/how-to/manage-postgresql-database-adminer/">How to manage a PostGreSQL database with Adminer</NextButton>
</Navigation> 
