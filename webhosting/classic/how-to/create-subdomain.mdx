...
1. Connect to your webhosting using your [FTP account](/webhosting/classic/concepts#ftp-account). A listing of your remote files and folders displays in the right part of the FTP client:
...
<Navigation title="See Also">
  <PreviousButton to="/webhosting/classic/how-to/enable-https/">How to enable HTTPS</PreviousButton>
  <NextButton to="/webhosting/classic/how-to/delete-subdomain">How to delete a subdomain</NextButton>
</Navigation>
