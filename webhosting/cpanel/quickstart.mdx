...
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/webhosting/cpanel/quickstart
dates:
...
If you are migrating from another webhosting offer to the new Cloud Hosting offer powered by cPanel, you might need to update your nameserver information with the following new addresses:
