...
content:
  ...
  paragraph: Discover Scaleway Managed Databases and how to access them for PostgreSQL and MySQL.
...
You can [create a MySQL database](/webhosting/classic/how-to/create-mysql-database/),[manage your MySQL database with PHPmyAdmin](/webhosting/classic/how-to/manage-mysql-database-phpmyadmin/) or [delete your MySQL database](/webhosting/classic/how-to/delete-mysql-database/). You can also [create](/webhosting/classic/how-to/create-postgresql-database/), [manage](/webhosting/classic/how-to/manage-postgresql-database-adminer/) or [delete](/webhosting/classic/how-to/delete-postgresql-database/) PostgreSQL databases. 
...
[Private Networks](/network/vpc/quickstart/) allows you to configure your own Layer-2 network with IPv4 adresses. You can therefore enhance the security of your system architecture by isolating it from the Internet. 
...
This improves performance by reducing the latency between your nodes. It also increases the security of your databases, since Instances in your Private Network can directly to your Database Instance, without passing through the public Internet.
...
|--------------------	|------------------------------------------------------------------------------------------------------	|
| Amsterdam (`nl-ams`) 	| `nl-ams-1` <Icon name="validate" />                                                                    	|
