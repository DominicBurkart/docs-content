...
We are the only cloud provider to offer private data center colocation with Scaleway Datacenter, Dedibox dedicated servers for maximum control and punch, or elastic computing with our modern Scaleway ecosystem with S3 compatibility, a rolling up-to-date Kubernetes and Terraform support all at the same time. 
...
However, if you need to reset your password, but you have difficulties accessing your email account, you will not be able to use this function. In this case, follow the authentication procedure described in our [documentation](/console/my-account/how-to/recover-a-lost-password/). The process is the same if you have activated 2FA but [lose your 2FA device and backup codes](/console/my-account/how-to/use-2fa#if-you-lose-your-2fa-device-and-your-backup-codes).
