---
meta:
  title: How to Create Models in your Django Application
  description: This page shows how to configure your Django Application
content:
  h1: How to Create Models in your Django Application
...
1. To create your app, make sure you are in the same directory as `manage.py` and type
  ...
  We will create two models: Question and Choice. A Question has a question and a publication date. A Choice has two fields: the text of the choice and a vote tally. Each Choice is associated with a Question.
...
1. When youre logged in, the `poll` app is not displayed on the admin console. To make it appear, edit the `polls/admin.py` to match the following:
  ```
