...
<Message type="requirement">
  ...
  - You have created a [Private Network](/elastic-metal/how-to/use-private-networks/) and [attached](/compute/elastic-metal/how-to/use-private-networks/#how-to-attach-and-detach-elastic-metal-servers-to-a-private-network) your Elastic Metal servers to it
</Message>
...
7. Click **Install this Elastic Metal server** to launch the installation.
  ...
  <Message type="tip">
  If you installed your Elastic Metal server without enabling the Private Network feature, you can enable or disable the feature at any time from your servers status page.
