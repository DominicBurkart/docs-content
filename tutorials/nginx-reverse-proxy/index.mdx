...
To [set up Nginx as a reverse proxy with Object Storage](https://www.scaleway.com/en/docs/tutorials/setup-nginx-reverse-proxy-s3/), you can copy and paste the following configuration in `nginx.conf`:
