...
content:
  h1: How to periodically delete unused images in your Container Registry
...
When overused, a Container Registry can become very dense, storing lots of unused images.
