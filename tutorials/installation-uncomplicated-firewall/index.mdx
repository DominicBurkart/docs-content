...
tags: compute networking ethernet Firewall server UFW Instance
categories:
  - compute
dates:
...
<Message type="note">
  If you are using an Elastic Metal server to follow this tutorial, make sure you do [not to block the nbd ports](#enabling-ufw-on-a-baremetal-instance) before applying the rules.
</Message> 
