---
meta:
  title: Installing LEMP-Stack (Linux, Nginx, MySQL, PHP) on Ubuntu Bionic Beaver
  description: How to install LEMP-Stack (Linux, Nginx, MySQL, PHP) on Ubuntu Bionic Beaver (18.04)
content:
  h1: Installing LEMP-Stack (Linux, Nginx, MySQL, PHP) on Ubuntu Bionic Beaver
  paragraph: How to install LEMP-Stack (Linux, Nginx, MySQL, PHP) on Ubuntu Bionic Beaver (18.04)
