...
Let's Encrypt provides a [certbot](https://certbot.eff.org/) to configure the Apache webserver automatically with Let's Encrypt.
2. Install certbot.
  ```bash
...
5. Reload the Apache configuration.
  ...
  systemctl reload apache2
  ```
8. Access your site with https: `https://example.com/`.
