...
steps:
  - step: Installing PgBouncer
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-pgbouncer/#-Installing-PgBouncer
  - step: Setting up PgBouncer
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-pgbouncer/#-Setting-up-pgBouncer
  - step: Connecting to the admin console with psql
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-pgbouncer/#-Connecting-to-the-admin-console-with-psql
  - step: Useful admin console commands
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-pgbouncer/#-Useful-admin-console-commands
  - step: Making an online restart
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-pgbouncer/#-Making-an-online-restart
  - step: Recommended configurations
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-pgbouncer/#-Recommended-configurations
  - step: Recommended authentication method
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-pgbouncer/#-Recommended-authentication-method
categories:
  - compute
dates:
