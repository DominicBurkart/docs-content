...
content:
  h1: How to Configure Real-time Alerting with IoT Hub and Slack
...
2. Add a new device and make sure to select the **Allow insecure connections** option.
  ...
  After you click **Add a device to your Hub**, you are taken to the credentials section. In this section, you can add a [Certificate Authority](/iot/iot-hub/concepts/#device-certificate) for your device. This step is not mandatory.
...
When you use this tutorial in a production setting, we recommend that you:
  ...
  - for important alerts, depending on the content of the alert, notify the right Slack channel using a [Serverless Function](/compute/functions/concepts/#serverless-functions) to make this choice.
