---
meta:
  title: Configure an Apache Kafka Messaging Cluster
  description: Discover how to configure an Apache Kafka messaging cluster.
content:
  h1: Configure an Apache Kafka Messaging Cluster
...
3. Download Kafka and extract it
  ...
  tar -zxf kafka-3.1.0-src.tgz
  sudo mv kafka-3.1.0-src /usr/local/kafka
