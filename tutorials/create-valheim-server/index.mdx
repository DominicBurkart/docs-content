---
meta:
  title: How to create a Valheim server with Scaleway
  description: In this tutorial you will learn how to create your own Valheim server with Scaleway Instances. We offer a large range of Instances that will suits your gaming needs for your Valheim server.
content:
  h1: How to create a Valheim server with Scaleway
  paragraph: In this tutorial you will learn how to create your own Valheim server with Scaleway Instances. We offer a large range of Instances that will suits your gaming needs for your Valheim server.
tags: compute image gameserver game play Valheim valheim-server Elements
hero: assets/scaleway_valheim.webp
steps:
  - step: Deploying an Instance
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorias/create-valheim-server/#deploying-your-virtual-instance
  - step: Installing SteamCMD
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorias/create-valheim-server/#installing-steamCMD
  - step: Installing the Valheim server
    type: HowToStep
    url: https://www.scaleway.come/en/docs/tutorias/create-valheim-server/#installing-the-valheim-server
  - step: Creating a systemd service
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorias/create-valheim-server/#creating-a-systemd-service
  - step: Protecting the server
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorias/create-valheim-server/#protecting-the-server
categories: 
  - compute
  - instances
---
...
2. Click on **Create an Instance** and enter the required information for your Instance: 
    ...
    * An **Instance Type**. It characterizes the performances of your instance. In this tutorial, we use a **DEV1-L** instance which provides 8GB RAM. If required you can choose a more powerful instance for very large multiplayer sessions. 
...
3. Change into the `valheim` user account:
    ...
    su valheim
    ```
4. Change into the users home directory:
    ```
    cd ~/
    ```
5. Create a new sub-folder in the users home directory to store the Valheim server files in: 
    ```
