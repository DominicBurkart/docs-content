---
meta:
  title: How to configure a NodeMCU device with IoT Hub
  description: Discover how to make a NodeMCU device communicating with Scaleway IoT Hub
content:
  h1: How to configure a NodeMCU device with IoT Hub
  paragraph: Discover how to make a NodeMCU device communicating with Scaleway IoT Hub
steps:
  - step: Configuring the Arduino IDE
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nodemcu-iot-hub/#-configuring-the-arduino-ide
  - step: Creating an IoT Hub
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nodemcu-iot-hub/#-creating-an-iot-hub
  - step: Connecting MQTT Explorer to Scaleway IoT Hub
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nodemcu-iot-hub/#-connecting-mqtt-explorer-to-scaleway-iot-hub
  - step: Connecting your ESP8266 to Scaleway IoT Hub
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nodemcu-iot-hub/#-connecting-your-esp8266-to-scaleway-iot-hub
  - step: Controlling a LED and measuring temperature and humidity
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nodemcu-iot-hub/#-controlling-a-led-and-measuring-temperature-and-humidity
  - step: Flow-Programming with Node-RED
    type: HowToStep
    url: https://www.scaleway.com//en/docs/tutorials/configure-nodemcu-iot-hub/#-flow-programming-with-nodered
categories: 
  - iot-hub
...
<Message type="requirement">
  ...
  - You have downloaded and insalled the [Arduino IDE](https://www.arduino.cc/en/software)
</Message>
...
* A 330 ohms [resistor](https://en.wikipedia.org/wiki/Resistor) (You can use a higher resitor, but it will make the LED less bright)
...
2. Select the **Flow Programming** Kickstart and choose your Hub and Device from the drop-down lists. Then select a region for your Kickstart to deploy. Click **Create** to deploy the Node-RED application on a [Instance](https://www.scaleway.com/en/virtual-instances/)
