...
<Message type="requirement">
  ...
  - You have installed [Docker](docs/tutorials/install-docker-ubuntu-bionic) on the instance
...
2. Update the package cache and upgrade the software already installed on the Instance using the `apt` package manager:
  ...
  ```
3. Install Docker, for more detailed instructions, follow our [tutorial](docs/tutorials/install-docker-ubuntu-bionic).
  ```
...
For more information concerning the Jitsi Meet Docker image, refer to the [official documentation](https://github.com/jitsi/docker-jitsi-meet).
