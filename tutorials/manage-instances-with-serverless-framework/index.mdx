...
To go further, refer to our [Terraform](https://www.scaleway.com/en/docs/tutorials/terraform-quickstart/) and [Serverless Functions](https://www.scaleway.com/en/docs/compute/functions/quickstart/) documentation.