---
meta:
  title: How to setup and configure Jupyter Notebook on a GPU Instance
...
content:
  h1: How to setup and configure Jupyter Notebook on a GPU Instance
...
1. Deploy a new [GPU Instance](/compute/instances/how-to/create-an-instance/) with the [Ubuntu ML](https://www.scaleway.com/en/imagehub/) image from the management console.
