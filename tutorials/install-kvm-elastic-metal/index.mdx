...
steps:
  - step: Installing the KVM Hypervisor and a First Guest
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/install-kvm-elastic-metal/#-Installing-the-KVM-Hypervisor-and-a-First-Guest
  - step: Forwarding Ports to Guests with IPtables
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/install-kvm-elastic-metal/#-Forwarding-Ports-to-Guests-with-IPtables
categories:
  - compute
  - elastic-metal
tags: console security KVM-Hypervisor servers Elastic-Metal First-Guest 
dates:
...
<Message type="requirement">
  ...
  - You have created a [Elastic Metal server](/compute/elastic-metal/how-to/create-server/) running Ubuntu Bionic Beaver (18.04)
</Message>
