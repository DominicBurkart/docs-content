...
In this example, the public Docker registry is used ("Docker Hub"), but it also possible to set up a [private registry](https://docs.docker.com/registry/deploying/) to distribute the image on your infrastructure, or to use the [Scaleway Container Registry](/docs/compute/container-registry/quickstart/).
