...
13. Configure the virtual networking as described in our [documentation](/compute/elastic-metal/how-to/configure-flexible-ip/) once the installation of the guest OS has completed. Then, you may run a ping test to check the connectivity of the virtual machine:
