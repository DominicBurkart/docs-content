...
content:
  h1: Run a messaging platform with RocketChat
...
2. Set the ownership and permissions of the application.
  ...
  ```
3. Create the `lib/systemd/system/rocketchat.service` file and open it in your favourite text editor. Copy the following content to create a service file for Rocket.chat:
  ```
  [Unit]
