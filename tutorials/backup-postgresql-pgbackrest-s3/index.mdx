---
meta:
  title: Backup PostgreSQL databases with pgBackRest to Object Storage
  description: How to install pgBackRest on Scaleway Instance for backing up PostgreSQL databases to Object Storage
content:
  h1: Backup PostgreSQL databases with pgBackRest to Object Storage
...
- You have created Instances running a [PostgreSQL database](https://www.scaleway.com/en/docs/tutorials/install-postgresql/) on Ubuntu/Debian or RHEL/Rocky Linux.
- You have sudo privileges or access to the root user.
- You have [created an Object Storage bucket](https://www.scaleway.com/en/docs/storage/object/how-to/upload-files-into-a-bucket)
</Message>
