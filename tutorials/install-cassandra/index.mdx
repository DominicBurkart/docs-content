...
- **listen_address**: This is the IP address that Cassandra will listen on for internal (Cassandra to Cassandra) communication. The software will try to guess the IP address of your Instance if you leave it blank, but it’s best to specify it yourself. This information will be specific on each node.
