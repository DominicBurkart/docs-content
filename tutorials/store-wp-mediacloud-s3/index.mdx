...
content:
  h1: Store Wordpress Media on Object Storage with Media Cloud
...
- You have a [Wordpress blog](/tutorials/wordpress-instantapp/) running on a [Instance](https://www.scaleway.com/en/virtual-instances/)
