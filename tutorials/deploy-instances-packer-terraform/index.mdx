---
meta:
  title: Deploy Cloud Instances with Packer and Terraform
  description: This tutorial explains how to build and deploy Cloud Instances with Packer and Terraform
content:
  h1: Deploy Cloud Instances with Packer and Terraform
...
To use Packer with Scaleway, you must [generate an API Key](/console/my-project/how-to/generate-api-key/) from the management console.
