...
[OpenProject](https://www.openproject.org/) is open source project management software. Available in more than 30 languages, it provides tools and features to assist teams with communication, collaboration and navigating the lifecycle of a project.
...
<Message type="requirement">
  ...
  - You have [configured an A-record pointing to your Instance's IP address](/network/dns-cloud/how-to/manage-dns-records/)
</Message>

## Installing OpenProject

1. [Connect to your Instance via SSH](/compute/instances/how-to/connect-to-instance/)
2. Update and upgrade the system. Then, install the `apt-transport-https` package, which allows the use of repositories accessed via the HTTP Secure protocol (HTTPS).
    ```
...
Follow the instructions to [create a Database Instance](/en/docs/managed-databases/postgresql-and-mysql/how-to/create-a-database/). Ensure that you select **PostgreSQL** as the database engine.
