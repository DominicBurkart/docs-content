...
In this tutorial you learn how to deploy the tool on a [Instance](https://www.scaleway.com/en/virtual-instances/) using the [Docker](https://www.docker.com/) InstantApp. 
