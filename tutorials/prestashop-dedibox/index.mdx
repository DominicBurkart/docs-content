...
8. Reload Nginx to activate the new configuration:
  ...
  ```
9. Download the [latest version](http://www.prestashop.com/en/download) of PrestaShop from the official website. At the time of writing this tutorial, it is version 1.7.8.5, and we will use it here. Replace the link with the latest version if required.
...
For more information on how to configure your PrestaShop e-shop towards your business requirements, refer to the [official documentation](https://www.prestashop.com/en/help).
