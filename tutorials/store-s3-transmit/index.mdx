...
content:
  h1: How to store objects with Object Storage and Transmit 5
...
To access Object Storage using s3md, you need to [configure your API key](/console/my-project/how-to/generate-api-key/).
