...
1. [Create an Elastic Metal server](/compute/elastic-metal/how-to/create-server/), ensuring you select the **Big Blue Button 2.4** image at step 2 of the creation wizard.
