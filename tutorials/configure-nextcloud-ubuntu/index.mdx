...
meta:
  ...
  description: This page shows how to install and configure Nextcloud on Ubuntu Bionic Beaver
content:
  h1: Install and Configure Nextcloud
  paragraph: This page shows how to install and configure Nextcloud on Ubuntu Bionic Beaver
categories:
  - compute
  - storage
  - instances
...
<Message type="requirement">
  ...
  - You have [created an Instance](/compute/instances/how-to/create-an-instance/) which is running Ubuntu Bionic Beaver (18.04 LTS)
...
## Securing the Web Interface with a Let's Encrypt SSL Certificate
...
[Let's Encrypt](https://letsencrypt.org) provides free SSL certificates to encrypt the connection to your Nextcloud instance.
...
1. Open your brower and type the address of your instance (For example: `https://your.domain.com`). You will see a login screen where you have to enter the user and password that you have created previously.
