...
Several choices are available, including:

- [Nginx](https://github.com/kubernetes/ingress-nginx)
- [Traefik](https://traefik.io/traefik/)
- [Traefik2](https://traefik.io/traefik/)
...
- You have [created a Kapsule cluster](/compute/kubernetes/how-to/create-cluster/) and deployed an ingress controller using the Application Library in the [Easy Deploy feature](/compute/kubernetes/how-to/enable-easy-deploy/).
...
You need a functioning Kubernetes Kapsule cluster with an ingress controller deployed with the [Easy Deploy (Application Library) feature](/compute/kubernetes/how-to/enable-easy-deploy/) to follow this tutorial. To deploy your ingress controller, go to the Easy Deploy tab of your existing cluster, create a new deployment, and select the Ingress controller of your choice in the application library.
</Message>
