...
tags: Saas software-as-a-Service software Django-Template
categories: 
  - compute
  - container-registry
dates:
...
- You have an account and are logged into the [Scaleway console](https://console.scaleway.com)
  ...
  - You have [created a private Container Registry namespace](/compute/container-registry/how-to/create-namespace)
  - You have [installed kubectl on your local machine](/compute/kubernetes/how-to/connect-cluster-kubectl/)
...
As noted in the requirements for this tutorial, you should already have [created a private Scaleway Container Registry namespace](/compute/container-registry/how-to/create-namespace/). For this tutorial, we use a namespace called `my_registry_namespace`.
