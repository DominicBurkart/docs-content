...
content:
  h1: How to Configure Puppet on Ubuntu Xenial
  paragraph: This page details how to install and configure Puppet
...
If it has not been done already, make sure you repeat these steps on every puppet agent.
