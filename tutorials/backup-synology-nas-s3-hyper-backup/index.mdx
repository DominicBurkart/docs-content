---
meta:
  title: How to backup your Synology NAS on Object Storage using Hyper Backup
  description: This page shows you how to backup your Synology NAS on Scaleway Object Storage using Hyper Backup
content:
  h1: How to backup your Synology NAS on Object Storage using Hyper Backup
  paragraph: This page shows you how to backup your Synology NAS on Scaleway Object Storage using Hyper Backup
steps:
  - step: Getting Started
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/backup-synology-nas-s3-hyper-backup/#Configuring-Hyper-Backup
categories:
  - storage
  - object-storage
tags: synology backup hyperbackup object-storage nas s3
dates:
  validation: 2022-03-10
  posted: 2019-12-03
---

## Synology Hyper Backup - Overview

[Synology Hyper Backup](https://www.synology.com/en-us/dsm/feature/hyper_backup) is a solution to backup your Synology NAS easily on Scaleway Object Storage.
...
5. Enter the credentials for your Scaleway Object Storage bucket:
    ...
    - **Access Key**: The `access key` of your [API key](/console/my-project/how-to/generate-api-key/)
    - **Secret Key**: The `secret key` of your [API key](/console/my-project/how-to/generate-api-key/)
...
For more information regarding Hyper Backup, you may refer to the [software specifications](https://www.synology.com/en-us/dsm/software_spec/hyper_backup) and the [official documentation](https://www.synology.com/en-us/knowledgebase/DSM/tutorial/Backup/How_to_back_up_your_data_to_cloud_services_with_Hyper_Backup).
