...
- You have created a [Container Registry](/compute/container-registry/quickstart/)
...
1. Create a [database user](/managed-databases/postgresql-and-mysql/how-to/add-users/) and [grant permissions](/databases/how-to/manage-permissions/) to the PostgreSQL database you want to use for umami. 
