---
meta:
  title: How to deploy an Ubuntu 22.04 LTS (Jammy Jellyfish) Instance on Scaleway
...
content:
  h1: How to deploy an Ubuntu 22.04 LTS (Jammy Jellyfish) Instance on Scaleway
  paragraph: In this tutorial you will learn how to deploy an Ubuntu 22.04 LTS (Jammy Jellyfish) Instance on Scaleway.
