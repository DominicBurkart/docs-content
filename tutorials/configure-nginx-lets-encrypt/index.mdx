...
meta:
  ...
  description: How to configure NGINX with Let's Encrypt to secure the connection to your webserver.
content:
  h1: Configuring NGINX with Let's Encrypt
  paragraph: How to configure NGINX with Let's Encrypt to secure the connection to your webserver.
categories:
  - compute
  - instances
