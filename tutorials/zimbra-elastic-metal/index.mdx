...
content:
  h1: Setup a Zimbra Collaboration Suite on Ubuntu Bionic Beaver
...
- You have [created an Elastic Metal server](/compute/elastic-metal/how-to/create-server/) which is running Ubuntu Bionic Beaver (18.04 LTS)
