---
meta:
  title: Setting up GitLab with a Database for PostgreSQL
  description: This page shows you how setup GitLab with a managed PostgreSQL database
content:
  h1: Setting up GitLab with a Database for PostgreSQL
...
1. [Create a Managed PostgreSQL Database Instance](/managed-databases/postgresql-and-mysql/how-to/create-a-database/) from the Scaleway console. We name our database `gitlab_production`.
  You are taken to your Database's **Overview** page.
