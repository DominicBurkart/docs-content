---
meta:
  title: Installation of Proxmox with software RAID on a Dedibox using KVM-over-IP
...
content:
  h1: Installation of Proxmox with software RAID on a Dedibox using KVM-over-IP
...
- You have a [Dedibox](https://www.scaleway.com/en/dedibox/) with [KVM-over-IP](/dedibox/kvm-over-ip/concepts/#kvm-over-ip) access
</Message>
