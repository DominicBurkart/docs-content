...
<Message type="note">
Q-in-Q mode is not available on all offers. If you add a server that is not compatible with Q-in-Q mode, an error message will appear. Do not hesitate to contact the [technical assistance](https://console.online.net/en/assistance/ticket/list) if you have any question regarding the Q-in-Q compatibility of a server.
</Message>
