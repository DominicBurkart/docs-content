...
### NATed network
You share the same IP address for all your virtual machines with a NAT configuration. Your physical server and its virtual machines are seen as one single server. Only the MAC address of your physical network card is broadcasted on the network.
