...
You can split your IPv6 prefix into several subnetworks and use them on your Dedibox servers both in Paris and Amsterdam. Each subnetwork has its own [DUID](/dedibox-network/ipv6/concepts/#duid) and can be configured individually.
