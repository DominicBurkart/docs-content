...
Activation of IPv6 SLAAC (stateless auto-configuration of addresses) assigns **one** `/128` IPv6 prefix to your server (one usable IPv6 address). This IP is statically linked to your server and can not be attributed to a another server.
