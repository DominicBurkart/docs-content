...
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/managed-databases/postgresql-and-mysql/how-to/add-users
dates:
...
<Navigation title="See Also">
  <PreviousButton to="/managed-databases/postgresql-and-mysql/how-to/create-a-database/">How to create a PostgreSQL or MySQL Database Instance</PreviousButton>
