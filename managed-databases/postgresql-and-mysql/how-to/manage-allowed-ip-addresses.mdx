...
<Navigation title="See Also">
  <PreviousButton to="/managed-databases/postgresql-and-mysql/how-to/manage-permissions/">How to manage user permissions</PreviousButton>
  <NextButton to="/managed-databases/postgresql-and-mysql/how-to/change-volume-type/">How to change volume type</NextButton>
</Navigation>
