...
<Message type="requirement">
- You have an account and are logged into the [Scaleway console](https://console.scaleway.com)
- You have a [Redis™ Database Instance](/managed-databases/redis/how-to/create-a-database-for-redis) Instance in [cluster mode](/managed-databases/redis/concepts/#cluster-mode)
</Message>
...
6. Check the details of the estimated cost and click **Validate**. 
  ...
  <Message type="note">
  When TLS is enabled, scaling your Database Instance horizontally will generate a new SSL certificate with additional IPs.
