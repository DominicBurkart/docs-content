...
content:
  h1: How to delete a labeling workspace
  paragraph: This page explains how to delete a labeling workspace
dates:
...
<Navigation title="See Also">
  <PreviousButton to="/ai/smart-labeling/how-to/access-annotation-server/">How to access the annotation server</PreviousButton>
</Navigation>
