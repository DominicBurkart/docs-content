...
Projects are groupings of Scaleway [resources](#resource). Every Scaleway Organization disposes of a default project, and you can create new projects if necessary. By grouping resources into Projects, you can then define access differently for each Project. 
