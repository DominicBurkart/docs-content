...
You need your secret key and the ID of the project you want to get for the step below. For this use-case, we are getting the project we have updated in the [updating projects step](/identity-and-access-management/api-cli/managing-projects/#updating-projects).
...
You need your secret key and the ID of the project you want to delete for the step below. For this use-case, we are deleting the project we have created in the [creating a project step](/identity-and-access-management/api-cli/managing-projects/#creating-a-project).
