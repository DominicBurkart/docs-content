...
- You are the Owner of the Organization, or an IAM user in an Organization where you have the [IAMManager or OrganizationManager](/identity-and-access-management/iam/reference-content/permission-sets/) permission set. 
...
1. In the **Applications** panel, click **Add applications**. A pop-up displays, prompting you to select the applicaiton to add.
