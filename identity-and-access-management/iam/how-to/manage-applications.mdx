...
4. Click **Generate API Key**. A screen displays showing the access key and secret key for the new API key and reminding you that this is your only chance to securely save the secret key:
