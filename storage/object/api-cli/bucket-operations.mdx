...
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/storage/object/api-cli/bucket-operations
dates:
...
</Message><Message type="important">
  This request will delete your selected bucket. To complete the command, your bucket must be empty.
</Message>ration is successful no output will be returned.
</Message>
