...
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/storage/object/api-cli/object-lock
dates:
...
The **Governance** mode ensures extra protection before any alterations can be completed. Indeed, an object can be permanently deleted only if:
  ...
  - The object does not have a legal hold in place. If it does, the legal hold [status token](https://scaleway.com/en/docs/s3-object-lock#-XML-Legal-Hold-Configuration-Token) must be set to OFF before deletion.
