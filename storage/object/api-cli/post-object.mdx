...
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/storage/object/api-cli/post-object
dates:
...
app.get("/", (req, res) => {
  ...
  html += "<form action='http://s3.fr-par.scw.cloud/my-bucket'  method='post' name='form1' enctype='multipart/form-data'>"
  html += "<table>"
