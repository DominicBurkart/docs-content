...
5. Choose one or more ways you wish to be notified. Insert the contact information in the corresponding boxes. If you have chosen to be informed by SMS or email, you may add several phone numbers and email addresses.
  <Lightbox src="scaleway-configuring-billing-alerts.webp" />
