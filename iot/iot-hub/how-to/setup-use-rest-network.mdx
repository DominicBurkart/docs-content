...
4. Click the **Add network** button to access the network creation wizard.
    <Lightbox src="assets/scaleway-iothub_network_add.webp" alt="" />
5. Complete the form by specifying the network's details:
    ...
    * Choose a topic prefix your network should publish to. You may leave this empty. All the messages published to this network will have their topics prefixed with this value.
    <Lightbox src="assets/scaleway-iothub_network_modal_rest.webp" alt="" />
...
<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/how-to/use-mqtt-webclient/">How to use MQTT webclient</PreviousButton>
  <NextButton to="/iot/iot-hub/how-to/setup-use-sigfox-network/">How to set up and use a Sigfox network</NextButton>
</Navigation>
