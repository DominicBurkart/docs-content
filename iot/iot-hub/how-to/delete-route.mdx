...
4. Click the <Icon name="more" /> icon next to the route you want to delete, and select **Delete** from the drop-down menu.
    <Lightbox src="assets/scaleway-iothub_routes_delete.webp" alt="" />

    A pop-up asks you to confirm the action.
5. Type **DELETE** and then click **Delete this Route**.

<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/how-to/change-plan/">How to change the product plan</PreviousButton>
  <NextButton to="/iot/iot-hub/how-to/delete-device/">How to delete a device</NextButton>
</Navigation>
