...
Devices use the [MQTT](http://mqtt.org/) protocol to send and receive messages. MQTT over WebSocket is also supported through a dedicated [network](/iot/iot-hub/how-to/connect-default-mqtt-network).
...
3. Click **Add devices** in the devices tab of your Hub.
    <Lightbox src="assets/scaleway-iothub_add_device.webp" alt="" />
...
5. Choose a **security setting** for your device. You can either deny or allow insecure connections.
    <Lightbox src="assets/scaleway-iothub_device_security.webp" alt="" />
6. Click **Add a device to your Hub**.
7. Download the credentials of the device and keep them safe. 
    <Lightbox src="assets/scaleway-iothub_device_credentials.webp" alt="" />
...
Once the device is added, you may continue to configure [IoT Hub Routes](https://www.scaleway.com/en/docs/scaleway-iothub-route/) to export your data to other Scaleway services.


<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/how-to/provide-own-certificate-authority">How to provide your own certificate authority</PreviousButton>
  <NextButton to="/iot/iot-hub/how-to/provide-own-device-certificate">How to provide your own device certificate</NextButton>
</Navigation>
