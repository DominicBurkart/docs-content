...
4. Click **Create a Route** in the routes tab. The **Add a new Route** wizard displays.
    <Lightbox src="assets/scaleway-iothub_routes_add.webp" alt="" />
...
6. Click **Add a new route** to create the route.

<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/how-to/setup-use-sigfox-network/">How to set up and use a Sigfox network</PreviousButton>
  <NextButton to="/iot/iot-hub/how-to/simulate-event/">How to simulate events</NextButton>
</Navigation>
