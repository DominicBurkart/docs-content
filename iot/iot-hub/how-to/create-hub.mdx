...
2. Click **Create a Hub**. The hub creation wizard displays.
    <Lightbox src="assets/scaleway-iothub_create.webp" alt="Create IoT Hub" />
...
5. Click **Create a Hub** or **Create a Hub and Add a Device**.
    <Message type="note">
      If you want to add directly a first device to the hub, click **Create a Hub and Add a Device** and continue with the [Add device](/iot/iot-hub/how-to/add-device) documentation.
    </Message>


<Navigation title="See Also">
  <NextButton to="/iot/iot-hub/how-to/enable-disable-hub/">How to enable or disable an IoT Hub</NextButton>
</Navigation>
