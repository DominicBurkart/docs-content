...
<Message type="tip">
  An MQTT Webclient is available in the console to publish and receive messages. Follow the procedure on this [tutorial](/iot/iot-hub/how-to/use-mqtt-webclient).
</Message>
...
<Message type="note">
  Filters can also be applied to [last will messages](/iot/iot-hub/concepts/#last-will-message).
</Message>
...
<Message type="important">
Issues when parsing the template will be reported through [Hub events](/iot/iot-hub/concepts/#hub-events) as warnings. In this case, the filter can be dropped from the list.
</Message>
...
<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/reference-content/hubs/">Understanding IoT Hubs</PreviousButton>
