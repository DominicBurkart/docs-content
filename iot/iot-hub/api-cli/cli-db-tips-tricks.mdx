...
You can find the documentation here: [IoT Hub Routes](/iot/iot-hub/how-to/create-route/).
...
<Message type="requirement">
  ...
  - You have followed the [Getting started with the IoT Hub CLI](/iot/iot-hub/api-cli/getting-started-with-iot-hub-cli) tutorial
  - You have a working PostgreSQL database, with valid credentials (username and password). 
  - You have set up environment variables as shown in the code box below:
...
<Message type="requirement">
  ...
  - You have followed the [Getting started with the IoT Hub CLI](/iot/iot-hub/api-cli/getting-started-with-iot-hub-cli) tutorial.
  - You have a working MySQL database, with valid credentials (username and password). You can use a [Scaleway Database instance](https://console.scaleway.com/rdb/instances), or any other MySQL instance publicly accessible.
  - You have set up environment variables as shown in the code box below
...
This is a port of the [Database Route section of the cli tutorial](/iot/iot-hub/api-cli/iot-hub-routes) to MySQL.
...
<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/api-cli/iot-hub-routes/">Configuring IoT Hub routes via the CLI</PreviousButton>
  <NextButton to="/iot/iot-hub/api-cli/using-twins/">Using Cloud Twins</NextButton>
</Navigation>
