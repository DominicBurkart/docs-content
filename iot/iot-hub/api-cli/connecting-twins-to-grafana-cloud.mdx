...
4. Go to the graphite configuration panel:
	...
	<Lightbox src="assets/grafanacloud-configuration-datasource-menu-graphite.webp" alt="" />
5. Get the following information from the Graphite configuration panel:
	...
	<Lightbox src="assets/grafanacloud-datasource-graphite-settings.webp" alt="" />
...
1. Go to your Grafana instance explore panel
	...
	<Lightbox src="assets/grafanacloud-explore.webp" alt="" />
2. View your data
	- enter the query (A)
	```
	...
	- see your data (C)
	<Lightbox src="assets/grafanacloud-explore-data.webp" alt="" />
