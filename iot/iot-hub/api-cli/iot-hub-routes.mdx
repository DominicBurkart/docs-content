...
<Message type="note">
  Find out more about IoT Hub Routes in the [Routes reference page](/iot/iot-hub/reference-content/routes/).
</Message>
...
<Message type="important">
  This section is a continuation of to the [Iot Hub CLI quickstart](/iot/iot-hub/api-cli/getting-started-with-iot-hub-cli). Make sure you followed the quickstart before beginning.
</Message>
...
<Message type="tip">
  More examples including MySQL and more advanced features are available on the [Database Routes tips & tricks](/iot/iot-hub/api-cli/cli-db-tips-tricks/) page.
</Message>
...
<Navigation title="See Also">
  ...
  <NextButton to="/iot/iot-hub/api-cli/cli-db-tips-tricks/">Discovering IoT Hub Database route tips and tricks</NextButton>
</Navigation>
