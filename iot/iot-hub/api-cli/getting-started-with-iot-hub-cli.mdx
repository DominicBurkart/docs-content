...
You can find the API reference documentation at the following link: [IoT API](https://developers.scaleway.com/en/products/iot/api/)
...
You can harness the real power of MQTT Pub/Sub with this blog post: [An Introduction to the MQTT protocol](https://blog.scaleway.com/introduction-to-mqtt-protocol/).


<Navigation title="See Also">
  <NextButton to="/iot/iot-hub/api-cli/getting-started-with-iot-hub-api/">Getting started with the IoT Hub API</NextButton>
</Navigation>
