...
This page shows you how to use [Cloud Twins](/iot/iot-hub/concepts#twins) through both REST and inband MQTT API, using the example of a Device consisting of an internet-enabled alarm control panel with a siren and door sensor, the alarm being activated or deactivated by a smartphone application. We show:
