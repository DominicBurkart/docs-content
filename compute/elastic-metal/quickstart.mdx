...
Scaleway [Elastic Metal](/compute/elastic-metal/concepts/#elastic-metal-server) are dedicated physical servers that you can order on-demand, like Instances. You can install an OS or other [image](/compute/elastic-metal/concepts/#image) on your Elastic Metal server and connect to it via SSH to use it as you require. You can power off the server when you are not using or, delete it from your account once you have finished with it. Elastic Metal servers are ideal for large workloads, big data, and applications that require increased security and dedicated resources.
...
1. Click **Elastic Metal** in the **Compute** section of the side menu. The Elastic Metal creation page displays.
2. Click **Create an Elastic Metal server** to launch the creation wizard.
...
1. Click **Elastic Metal** in the **Compute** section of the side menu.
...
4. Click **Power off this Elastic Metal server**.
