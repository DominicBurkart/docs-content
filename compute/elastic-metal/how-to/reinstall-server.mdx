...
<Navigation title="See Also">
  <PreviousButton to="/compute/elastic-metal/how-to/reboot-server/">How to reboot a server</PreviousButton>
  <NextButton to="/compute/elastic-metal/how-to/shutdown-server/">How to shut down a server</NextButton>
</Navigation>
