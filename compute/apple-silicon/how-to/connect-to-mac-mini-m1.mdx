...
This page shows how to connect to your [Mac mini M1](/compute/apple-silicon/concepts#mac-mini-m1) via either [VNC](/compute/apple-silicon/concepts#vnc) or [SSH](/console/my-account/concepts/#ssh-key).
...
<Navigation title="See Also">
  <PreviousButton to="/compute/apple-silicon/how-to/create-mac-mini-m1/">How to create a Mac mini M1</PreviousButton>
  <NextButton to="/compute/apple-silicon/how-to/reboot-mac-mini-m1/">How to reboot a Mac mini M1</NextButton>
</Navigation>
