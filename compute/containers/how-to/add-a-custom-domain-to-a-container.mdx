...
1. On your domain provider's platform (for example [Scaleway's domains](/network/dns-cloud/how-to/manage-dns-records/)), add a CNAME record pointing to your container default URL in the domains DNS zone file.
