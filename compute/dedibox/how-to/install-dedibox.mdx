...
<Navigation title="See Also">
  <PreviousButton to="/compute/dedibox/how-to/order-dedibox">How to order a Dedibox</PreviousButton>
  <NextButton to="/compute/dedibox/how-to/connect-to-dedibox">How to connect to a Dedibox</NextButton>
</Navigation>