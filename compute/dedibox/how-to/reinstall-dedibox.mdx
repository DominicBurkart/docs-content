...
<Message type="requirement">
  ...
  - You have [ordererd](/compute/dedibox/how-to/order-dedibox) a Dedibox server
</Message>
...
3. On the server's dashboard, scroll down to **Reinstall Dedibox Server**. Then click **Renstall Dedibox seserver** to launch the OS installation wizard.
4. Select the type and version of the operating system you want to install. 
    <Message type="tip">
      For more information about OS types, refer to the [dedicated servers concepts page](/compute/dedibox/concepts#os-type).
    </Message>
5. Personalize the following [partitioning](/compute/dedibox/concepts#partitioning) parameters:
...
<Navigation title="See Also">
  <PreviousButton to="/compute/dedibox/how-to/use-rescue-mode">How to use rescue mode</PreviousButton>
  <NextButton to="/compute/dedibox/how-to/terminate-dedibox">How to delete a Dedibox</NextButton>
</Navigation>