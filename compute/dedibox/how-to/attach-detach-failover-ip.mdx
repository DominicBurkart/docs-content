...
<Message type="requirement">
  ...
  - You have [ordered](/compute/dedibox/how-to/order-failover-ip/) a failover IP
</Message>
...
<Message type="tip">
  Alternatively, you can attach a failover IP by clicking on <Icon name="more" /> -> **Assign IP**. Then enter the ID of your Dedibox to attach the IP.
</Message>
...
<Navigation title="See Also">
  <PreviousButton to="/compute/dedibox/how-to/order-failover-ip">How to order a failover IP</PreviousButton>
  <NextButton to="/compute/dedibox/how-to/configure-failover-ip">How to configure a failover IP</NextButton>
</Navigation>