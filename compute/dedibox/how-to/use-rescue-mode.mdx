...
<Message type="requirement">
  ...
  - You have [ordered](/compute/dedibox/how-to/order-dedibox) and [installed](/compute/dedibox/how-to/install-dedibox) an Dedibox server
</Message>
...
1. Click **Dedibox** in the **Compute** section of the [Scaleway Console](https://console.scaleway.com) side menu. The Dedibox dashboard displays.
...
<Navigation title="See Also">
  <PreviousButton to="/compute/dedibox/how-to/modify-server-options">How to modify server options</PreviousButton>
  <NextButton to="/compute/dedibox/how-to/reinstall-dedibox">How to reinstall a Dedibox</NextButton>
</Navigation>