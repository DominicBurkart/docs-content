...
<Navigation title="See Also">
  <PreviousButton to="/compute/dedibox/how-to/configure-failover-ip">Configure a failover IP</PreviousButton>
  <NextButton to="/compute/dedibox/how-to/activate-ipv6-block">How to activate an IPv6 block</NextButton>
</Navigation>