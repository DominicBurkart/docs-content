...
<Message type="requirement">
  ...
  - You have [created](/compute/dedibox/how-to/order-dedibox) and [installed](/compute/dedibox/how-to/install-dedibox) a Dedibox, and transferred your SSH key to the server during installation
</Message>
