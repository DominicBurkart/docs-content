...
<Navigation>
  <PreviousButton to="/compute/functions/how-to/package-function-in-zip/">How to package a function in a zip file</PreviousButton>
  <NextButton to="/compute/functions/how-to/add-a-custom-domain-name-to-a-function/">How to add a custom domain to a function</NextButton>
</Navigation>
