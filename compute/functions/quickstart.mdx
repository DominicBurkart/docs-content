...
4. Complete the following steps in the wizard: 
    ...
    - Optionally, use the **advanced options** to add [triggers](/compute/functions/concepts/#trigger) to your function deployment. Adding triggers enables the function to handle events coming from sources other than an HTTP endpoint, such as CRON (time-based jobs).
...
4. Type **DELETE** in the pop-up that asks you to confirm the action, then click **Delete this function**.
<Message type="tip">
