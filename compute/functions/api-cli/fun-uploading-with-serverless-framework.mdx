...
<Message type="tip">
  You can find other examples of trigger configurations [on the Scaleway Serverless Github page](https://github.com/scaleway/serverless-scaleway-functions/tree/master/examples/nodejs-schedule).
</Message>
