...
This page shows examples of functions in [Python](#python), [Node](#node), and [Golang](#go) that can be used in your Serverless Functions projects, such as functions that allow you to:
...
```
<Message type="note">
If you want to use other libraries like `request`, you need to upload your project [using Serverless Framework](https://www.scaleway.com/en/docs/compute/functions/api-cli/fun-uploading-with-serverless-framework/) (recommanded)
or by [using a zip-file](https://www.scaleway.com/en/docs/compute/functions/how-to/package-function-in-zip/).
</Message>
