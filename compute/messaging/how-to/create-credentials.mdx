---
meta:
  title: How to create credentials for a Messaging namespace
  description: This page explains how to create credentials for a Messaging namespace
content:
  h1: How to create credentials for a Messaging namespace
  paragraph: This page explains how to create credentials for a Messaging namespace
dates:
  validation: 2022-08-11
  posted: 2022-08-11 
---

This page shows how to create [credentials](/compute/messaging/concepts#namespace) for a [Messaging namespace](/compute/messaging/concepts#namespace). Credentials give their bearer (e.g. services and platforms) access to your namespace. The process of creating credentials differs depending on the namespace type ([NATS](/compute/messaging/concepts#nats) or [SQS/SNS](/compute/messaging/concepts#sqssns)).
...
4. Enter a name for these credentials, and click **Generate credentials**.
  The credentials are created and a button displays prompting you to to download them in a `.creds` file. 
...
<Navigation title="See Also">
  <PreviousButton to="/compute/messaging/how-to/create-namespace/">How to create a namespace</PreviousButton>
  <NextButton to="/compute/messaging/how-to/manage-credentials/">How to manage credentials</NextButton>
</Navigation>
