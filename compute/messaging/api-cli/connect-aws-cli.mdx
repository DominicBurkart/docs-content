...
meta:
  ...
  description: This page explains how to connect your Scaleway Messaging SNS/SQS namespace to the AWS-CLI
content:
  h1: Connecting your SNS/SQS namespace to the AWS-CLI
  paragraph: This page explains how to connect your Scaleway Messaging SNS/SQS namespace to the AWS-CLI
tags: messaging
categories: 
  - messaging
---

The AWS-CLI is an open-source tool built on top of the AWS SDK for Python (Boto) that provides commands for interacting with AWS services. With minimal configuration, you can start using the AWS-CLI with your Scaleway Messaging SNS/SQS namespace. This allows you to create, list and manage your queues and topics, send messages and much more, all from your command line.

This guide shows you how to install the AWS-CLI and configure it for connection to your Scaleway Messaging SNS/SQS namespace.
...
To interact with Scaleway Messaging, both `aws-cli` and `awscli-plugin-endpoint` need to be installed. The `awscli-plugin-endpoint` is a useful plugin to help people more easily access third-party providers such as Scaleway.
...
Now you have installed the AWS-CLI, you need to configure it for use with your Scaleway Messaging SNS/SQS namespace.
...
1. Create a file named `~/.aws/config` by running the following command:
  ...
  ```
2. Open the `~/.aws/config` file you just created in a text editor and edit it as follows:
...
3. Generate a credentials file using the following command:
  ...
  aws configure
  ```
4. Open the `~/.aws/credentials` file you just created, and add the access key and secret key you saved when you generated your [SNS/SQS namespace's credentials](/compute/messaging/how-to/create-credentials/) as follows:
