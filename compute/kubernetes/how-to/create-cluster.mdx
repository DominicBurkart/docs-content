...
This document concerns the creation and management of a **Kubernetes Kapsule** cluster. To create a Kubernetes Kosmos Cluster, refer to the [alternative documentation](/compute/kubernetes/how-to/create-kosmos-cluster)
...
<Lightbox src="assets/scaleway-kapsule_creation.webp" alt="" />

Once your cluster is created, it appears in the Clusters List.
<Lightbox src="assets/scaleway-kapsule_cluster_list.webp" alt="" />


<Navigation title="See Also">
  <NextButton to="/compute/kubernetes/how-to/edit-cluster/">How to manage a Kapsule cluster</NextButton>
</Navigation>
