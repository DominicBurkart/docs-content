...
<Message type="note">
  This document concerns the management of a Kosmos cluster. For a Kapsule cluster, refer to the [corresponding documentation for Kapsule](/compute/kubernetes/how-to/edit-cluster)
</Message>
...
5. Complete the following steps of the wizard:
    * Choose a **pool type**. This can be a Scaleway Kubernetes Kapsule Pool or a Kubernetes Multi-Cloud Pool. This document concerns the addition of a Multi-Cloud Pool.
        <Lightbox src="assets/scaleway-choose-pool-type.webp" alt="" />
...
4. Click the **+ Add an external node** button
  ...
  <Lightbox src="assets/scaleway-add-external-node-instr.webp" alt="" />
