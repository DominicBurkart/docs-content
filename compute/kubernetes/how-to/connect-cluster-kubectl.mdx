...
1. [Install kubectl](/tutorials/kubeflow-on-kapsule/#installing-kubectl-on-your-local-computer) on your local computer.
...
<Navigation title="See Also">
  <PreviousButton to="/compute/kubernetes/how-to/edit-kosmos-cluster/">How to manage a Kosmos cluster</PreviousButton>
  <NextButton to="/compute/kubernetes/how-to/deploy-image-from-container-registry/">How to deploy an image from Container Registry</NextButton>
</Navigation>
