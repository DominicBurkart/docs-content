...
4. Click **Detach IP** on the pop-up that asks you to confirm the action.
  <Message type="tip">
  You can also detach a flexible IP by following step 1 above, then clicking on the **Flexible IPs** tab. From here, click <Icon name="more"/> next to said Instance, and select **Detach**.
...
3. Click **Create a flexible IP** (or the <Icon name="plus" /> button if you have existing flexible IPs). The flexible IP creation wizard displays.
...
5. Click **Create a flexible IP** to finish.
...
1. Click **Instances** in the **Compute** section of the side menu. The Instances page displays.
2. Navigate to the **Flexible IPs** tab.
3. Click <Icon name="more"/> next to the flexible IP that you want to attach to an Instance. In the drop down-menu which opens, click **Select another Instance**. 
  <Message type="note">
...
4. Confirm the Instance that you want to attach to this flexible IP in the pop-up window, and click **Attach this flexible IP**.
