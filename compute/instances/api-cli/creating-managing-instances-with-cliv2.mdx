...
1. Type the following command in your terminal to obtain a local-image UUID:
  ...
  ```
2. Type the following command in your terminal to create an Instance: 
...
1. Type the following command in your terminal to create a [Block Volume](/compute/instances/concepts/#block-volumes/): 
...
Ensure that your Instance is powered off, and type the following command in your terminal. Replace "your-server" with the ID of your server. 
