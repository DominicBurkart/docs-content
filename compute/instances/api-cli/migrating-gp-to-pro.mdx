...
<Message type="requirement">
  ...
  - You have [installed](https://github.com/scaleway/scaleway-cli#scaleway-cli-v2) and [configured](https://www.scaleway.com/en/docs/compute/instances/api-cli/creating-managing-instances-with-cliv2#configuring-the-cli) the Scaleway CLI (version 2.5.3 or later)
</Message>
