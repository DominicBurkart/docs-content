...
Make sure you check our [documentation](https://www.scaleway.com/en/docs/compute/instances/how-to/create-an-instance/) to create an Instance booting on a block volume or to [change the boot volume](https://www.scaleway.com/en/docs/compute/instances/how-to/use-boot-modes/#how-to-change-the-boot-volume) of your Instance.
